...
saveRDS(qtle, file = here("Natri_data/qtle_10_states.rds"))

# Load mashr data --------------------------------------------------------------

input_path <- "Natri_data/mashr/"
...
# About 5 minutes per lineage here
start <- Sys.time()
...
saveRDS(qtle_mashr_ds, file = here("Natri_data/qtle_mashr_ds_10_states"))
...
# Save full data
saveRDS(qtle_mashr, file = here("Natri_data/qtle_mashr_all_10_states"))
